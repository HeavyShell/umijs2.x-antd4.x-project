        ...
        <div className={styles.header}>
          ...
          <div className={styles.navbar}>
            <Dropdown 
              ...
              <Button type={'primary'} size={'small'} style={{marginRight:'10px'}} icon={<GlobalOutlined />}>{formatMessage({id: 'App.lang'})}</Button>
            </Dropdown>
            <Button type={'primary'} size={'small'} icon={<LogoutOutlined />} onClick={()=>{
              dispatch({
                type:'app/logout',
                payload:{}
              })
