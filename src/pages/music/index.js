...
import { Row, Col, List, Spin, Avatar, Radio } from 'antd';
      ...
      <Spin tip="Loading..." spinning={data.length==0?true:false} >
        ...
        <List
          ...
          renderItem={(item,index) => (
            <List.Item
              key={item.id+'-'+index}
              actions={[<IconText type="StarOutlined" text={item.collected_count} />, <IconText type="LikeOutlined" text={item.duration} />, <IconText type="MessageOutlined" text={item.songs_count} />]}
